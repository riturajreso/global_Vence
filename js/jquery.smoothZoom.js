...
(function ($, window, document) {
	...
	******************************************************************************/
	var defaults = {
		...
		mouse_WHEEL: false,							//Enable/disable mousewheel zoom
		...
		background_COLOR: '',				//Background colour of image container
		...
		init: function () {
			...
			if (self.mouse_dbl_click) {
				...
				self.$holder.bind('dblclick.sz', function (e) {
					...
					var img_dbl_height = $('.img-overflow').height();
					$(".smooth_zoom_preloader").css("height",img_dbl_height);
					$(".smooth_zoom_preloader").css("overflow","auto");
					$('.img-overflow').css("overflow","hidden");
					$('.smooth_zoom_preloader').kinetic();			
