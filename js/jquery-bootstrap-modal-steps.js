...
(function($){
    ...
    $.fn.modalSteps = function(options){
        ...
        var settings = $.extend({
            btnCancelClass: 'glyphicon glyphicon-remove',
            btnPreviousClass: 'glyphicon glyphicon-chevron-left',
            btnNextClass: 'glyphicon glyphicon-chevron-right',
            btnLastStepClass: 'glyphicon glyphicon-chevron-right',
